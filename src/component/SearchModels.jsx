...
const SearchModels = () => {
  return (
    <div className="lg:w-[30%] md:w-[40%] sm:w-[45%] w-[95%]  px-4 border-l-[4px] rounded-2xl items-center border-l-blue absolute top-[12%] sm:translate-x-0 left-1/2 -translate-x-1/2 md:left-[40%]  lg:left-1/2 lg:-translate-x-1/2 searchmodelbg z-10">
